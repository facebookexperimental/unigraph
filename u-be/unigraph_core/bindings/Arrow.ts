 ...
 * metrics, etc.
 */
export type Arrow = { tag: string | null, branch: string | null, properties: { [key in string]?: string } | null, points_from: NodeIDX, points_to: NodeIDX, excluded: boolean, message: string | null, };
