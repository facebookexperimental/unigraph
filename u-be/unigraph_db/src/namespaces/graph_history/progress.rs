...
pub(super) const PROGRESS_WINDOW: usize = 100;
...
impl Throughput {
    ...
    pub(super) fn add(&mut self, done: u64) {
        self.done += done;
    }
    ...
    pub(super) fn label(&self, step: i64, total: i64, unit: &str) -> String {
...
pub(super) fn windows(total: i64) -> i64 {
