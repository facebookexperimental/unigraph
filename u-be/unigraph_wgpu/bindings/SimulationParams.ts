 ...
 */
gravity_force_multiplier: number, gravity_force_a: number, 
/**
 * value increase or decrease the force
 * that edges pull nodes together
 */
edge_force_multiplier: number, edge_force_a: number, edge_force_b: number, 
/**
 * How much the nodes are pulled towards the center of the space.
 */
center_pull_force_multiplier: number, disable_gravity: boolean, disable_edge_forces: boolean, disable_center_pull: boolean, total_force_multiplier: number, 
/**
 ...
 */
slowdown: number, selection: Selection, colors: SimulationColors, 
/**
